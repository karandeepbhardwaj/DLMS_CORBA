...
import dlmsServerInterfaceImpl.ConLibraryImplementation;
...
public class ConcordiaServer{
	...
	public static void main (String[] args ) {
		try {
			...
			ConLibraryImplementation addobj = new ConLibraryImplementation();
			addobj.setORB(orb);
			...
			NameComponent path[] = ncRef.to_name(Constants.CONCORDIA_SERVER_NAME);
		...
		System.out.println("Concordia Exiting ...");
	}
}